...
namespace LeaveON.Controllers
{
    public class CountriesAPIController : ApiController
    {
        ...
        {
            //IEnumerable<Country> countries= db.Countries.Include(x => x.Deparments).ToList<Country>();
            //return db.Countries.Include(x =>x.Deparments).ToList();
            //return countries;
            return db.Countries;
        }
        //public IEnumerable<Country> GetCountries()
        //{
        //    IEnumerable<Country> countries = db.Countries.ToList<Country>();

        //    return countries;//db.Countries;
        //}
